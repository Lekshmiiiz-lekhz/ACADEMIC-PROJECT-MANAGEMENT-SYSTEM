...
if ($row1['cnfirm']=='0') {
    ?>
     <div class="alert alert-warning" role="alert">
        <?php echo $row1['t_discription'];?> <a href="#" class="alert-link"><P><h4><form action="submit_task.php" method="POST">
       <input class="btn btn-primary" type="submit" value="<?php echo $row1['t_name'];?>"> 
       <input type="hidden" value="<?php echo $row1['t_id'];?>"> 
        </form></h4></a></P> will be deactivated after  <?php echo $row1['t_due_date'];?>
        <audio src="../noti.mp3" autoplay="autoplay" ></audio>
      </div>
...
<form action="view_task_insight.php" method="POST">
       <input class="btn btn-primary" type="submit" value="<?php echo $row1['t_name'];?>"> 
       <input type="hidden" value="<?php echo $row1['t_id'];?>"> 
</form>
  <?php
