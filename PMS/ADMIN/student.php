...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td>Student ID</td>
    <td><input class="form-control"  type="text"  id="in" name="id"/></td>
    
  </tr>
  <tr>
  
    <td>Student Name</td>
    <td><input type="text"class="form-control"  id="in" name="stname"/></td>
    
  </tr>
  <tr>

    <td>Email</td>
    <td><input type="email" class="form-control" id="in" name="stemail"/></td>
    
  </tr>
  <tr>

    <td>Phone No</td>
    <td><input type="text" class="form-control" id="in" name="stphone"/></td>
    
  </tr>
  <tr>
    <td>Password</td>
    <td><input type="password" class="form-control" id="in" name="stpass"/></td>
    
  </tr>
  <tr>
    <td>Year</td>
    <td><input type="text" class="form-control" id="in" name="styear"/></td>
  ...
  <br/><br/>
    ...
    <td>Stream</td>
    <td><select name="stream" class="form-control" style="width: 193px; height: 2em; font-size: 15px;">
